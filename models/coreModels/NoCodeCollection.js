...
const noCodeCollectionsSchema = new mongoose.Schema({
  ...
  removerController: { type: mongoose.Schema.Types.Mixed },
  ...
  collectionSchema: [
    {
      ...
      default: {
        tyep: mongoose.Schema.Types.Mixed,
      },
      formField: {
        fieldType: {
          type: String,
...
module.exports = mongoose.model('NoCodeCollection', noCodeCollectionsSchema);
